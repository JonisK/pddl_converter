; mdp
(define (domain saint_reduced_all)
	...
	(:action manual_cycle
		:parameters (
		 ?vitem_task_planner - num
		 ?vgripper_task_planner - num
		)
		:precondition (
			and (at l_task_planner)
			(value gripper_task_planner ?vgripper_task_planner)
			(value item_task_planner ?vitem_task_planner)
			(and 
							(value movability_task_planner n0)
	...
	(:action semi_autonomous_detect_item
		:parameters (
		 ?vitem_task_planner - num
		 ?vgraspability_task_planner - num
		)
	...
	(:action semi_autonomous_grasp_item
		:parameters (
		 ?vgraspability_task_planner - num
		)
		:precondition (
	...
	(:action semi_autonomous_reset_motion
		:parameters (
		)
		:precondition (
			and (at l_task_planner)
	...
	(:action technician_remove_item_from_gripper
		:parameters (
		)
		:precondition (
			and (at l_task_planner)
			(value item_task_planner n6)
	...
	(:action technician_reset_conveyor
		:parameters (
		 ?vconveyor_task_planner - num
		)
		:precondition (
			and (at l_task_planner)
			(value conveyor_task_planner ?vconveyor_task_planner)
			(not (value conveyor_task_planner n2))
	...
	(:action technician_reset_sorter
		:parameters (
		 ?vsorter_task_planner - num
		)
		:precondition (
			and (at l_task_planner)
			(value sorter_task_planner ?vsorter_task_planner)
			(not (value sorter_task_planner n1))
