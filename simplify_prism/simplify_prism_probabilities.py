            ...
            if regex.search("module task_planner", line):
                ...
                if regex.search("endmodule", line):
                    ...
                    if current_action:
                        ...
                        elif roll_dice and regex.search("_unsuccessful", current_action) and check_autonomy(autonomy, current_action, verbose):
                            print("Found the unsuccessful action. Writing simplified action to destination") if verbose else None
                            roll_dice = False
                            # Find out the successful effects
                            effects_roll_dice = regex.search(effects_pattern, line)
                            effects_roll_dice = line[effects_roll_dice.regs[0][0]:effects_roll_dice.regs[0][1]]
